...
export function FeedbackSuccessStep({onFeedbackRestartRequested}:FeedbackSuccessStepProps){
  ...
  return(
    ...
    <div className="flex flex-col items-center py-10 w-[304px]">
      ...
      className="py-2 px-6 mt-6 bg-[#F4F4F5] dark:bg-zinc-800 rounded-md border-transparent text-sm lending-6 hover:bg-zinc-300 hover:dark:bg-zinc-700  focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-zinc-900 focus:ring-brand-500 transition-colors disabled:opacity-50 disabled:hover:bg-brand-500"
