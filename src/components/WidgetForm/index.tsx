...
export function WidgetForm(){
  ...
  return(
    <div className="bg-[#FFFF] dark:bg-zinc-900 p-4 relative rounded-2xl mb-4 
      ...
      junto com a 
      <a className="underline underline-offset-2" target="_blank" href="https://rocketseat.com.br"> Rocketseat </a>
      </footer>
    </div>
  )
}